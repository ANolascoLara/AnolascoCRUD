...
namespace SL_WCF1.CRUDWebService
{
    ...
    public class Usuario : IUsuario
    {
        ...
        public SL_WCF1.CRUDWebService.Result Delete(int IdUsuario)
        {
            ML.Result result = BL.Usuario.DeleteEF(IdUsuario);
            return new SL_WCF1.CRUDWebService.Result
            {
        ...
        public SL_WCF1.CRUDWebService.Result GetAll(ML.Usuario usuario) {
        ...
        public SL_WCF1.CRUDWebService.Result Add(ML.Usuario usuario) {
        ...
        public SL_WCF1.CRUDWebService.Result Update(ML.Usuario usuario) {
        ...
        public SL_WCF1.CRUDWebService.Result GetById(int IdUsuario) {
