...
namespace DL_EF
{
    ...
    public partial class ANolascoProgramacionNCapasEntities : DbContext
    {
        public ANolascoProgramacionNCapasEntities()
            : base("name=ANolascoProgramacionNCapasEntities")
        {
        }
        ...
        public virtual ObjectResult<UsuarioGetAllViewSQL_Result> UsuarioGetAllViewSQL(string nombre, string apellidoPaterno, string apellidoMaterno, Nullable<int> idRol)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<UsuarioGetAllViewSQL_Result>("UsuarioGetAllViewSQL", nombreParameter, apellidoPaternoParameter, apellidoMaternoParameter, idRolParameter);
        }
